...
void drawallshapes(void){
    ...
    if(psvg == NULL){
        ...
        svg_eclipse(psvg, 64, 160, 32, 16, "#FF0000", "#800000", 4);
...
void iwanttobelive(void){
    ...
    if(psvg == NULL){
        ...
        svg_eclipse(psvg, 256, 374, 8, 14, "#808080", "#808080", 0);
        svg_eclipse(psvg, 252, 372, 3, 2, "#000000", "#000000", 0);
        svg_eclipse(psvg, 260, 372, 3, 2, "#000000", "#000000", 0);
        ...
        svg_eclipse(psvg, 256, 400, 64, 16, "silver", "silver", 4);
